...
describe('cifrado a nivel de campo (AES-256-GCM)', () => {
  ...
  it('alterar el ciphertext hace fallar el descifrado (autenticación)', () => {
    ...
    // Se manipula el PRIMER carácter: en base64url sus 6 bits son todos significativos.
    // Tocar los últimos puede caer sobre bits de relleno y decodificar al mismo byte.
